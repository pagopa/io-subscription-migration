...
describe("Create SQL for Delegates", () => {
  it("should generate a valid SQL", () => {
    const expectedSql = `select "sourceId", "sourceName", "sourceSurname", "sourceEmail", count("subscriptionId") from "Schema"."Table" where "organizationFiscalCode" = '12345678901' group by "sourceId", "sourceName", "sourceSurname", "sourceEmail"`;
